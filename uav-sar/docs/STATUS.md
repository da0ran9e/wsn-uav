...
| `docs/visualize/replay-3d.html` | **3D replay**, generated by `tools/make_viewer3d.py`. Orbitable scene showing the two flight levels (FAST 35 m, DATA 20 m) that a flat map cannot distinguish. Self-contained, no external libraries |
